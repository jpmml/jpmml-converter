...
public class TypeUtil {
	...
	public DataType getDataType(Object value){
		...
		throw new ConversionException("Expected a Java primitive value, got " + (value != null ? ExceptionUtil.formatClass(value.getClass()) : null));
	}
	...
	public DataType getDataType(Collection<?> values, DataType defaultDataType){
...

		{
			...
			throw new ConversionException("Expected all values to be of the same data type, got " + ExceptionUtil.formatValues(dataTypes));
		}
	}
